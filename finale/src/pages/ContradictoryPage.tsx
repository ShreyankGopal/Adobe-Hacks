  ...
  return (
    <div className="min-h-screen bg-[#030303]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-4 h-[calc(100vh-120px)]">
        {/* Left panel */}
        <div className="lg:col-span-1 bg-[#1a1a1a]/95 backdrop-blur-sm rounded-xl shadow-xl border border-purple-900/50 p-4 flex flex-col max-h-full overflow-hidden">
          <div className="flex-shrink-0">
            <h2 className="text-lg font-bold text-white mb-1">Contradiction Analysis</h2>
            <p className="text-xs text-gray-400 mb-3">Conflicting information found.</p>
          </div>
        ...
        {/* Right panel */}
        <div className="lg:col-span-3 bg-[#1a1a1a]/95 text-white backdrop-blur-sm rounded-xl shadow-xl border border-purple-900/50 p-4 flex flex-col max-h-full overflow-hidden">
          <div className="flex justify-between items-center mb-3">
            <h3 className="text-xl font-bold text-white">Contradiction Results</h3>
            <button
          ...
          <div className="flex-1 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
            {result?.extracted_sections?.length > 0 ? (
              ...
              <div className="text-center text-gray-500 h-full flex flex-col justify-center">
                ...
                <div className="text-xl font-semibold mb-2">No Contradictory Sections Found</div>
                <div className="text-sm">Run a contradiction query to see results.</div>
              </div>
            )}
                ...
                {result?.subsection_analysis?.map((sa: any, idx: number) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="text-xs text-gray-300 bg-red-900/40 px-2 py-1 rounded">
                        Page {sa.page_number}
                      </div>
                    </div>
